...
namespace Multiflag
{
    ...
    public class U16BitflagSet : FlagSet<ushort>
    {
        ...
        public override ushort Union(ushort first, ushort second) => U16BitManipulator.Current.Or(first, second);

        public override ushort Difference(ushort first, ushort second) =>
            U16BitManipulator.Current.AndNot(first, second);

        public override bool IsSupersetOf(ushort first, ushort second) =>
            U16BitManipulator.Current.AndEquals(first, second);
    }
}