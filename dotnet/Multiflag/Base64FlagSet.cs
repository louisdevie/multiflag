...
namespace Multiflag
{
    ...
    public class Base64FlagSet : FlagSet<string>
    {
        ...
        public override string Empty() => Base64Codec.Zero;

        public override bool IsEmpty(string flags) => Base64Codec.DecodesToZero(flags);

        public override string Union(string first, string second) => Base64Codec.BitwiseOr(first, second);

        public override string Difference(string first, string second) => Base64Codec.BitwiseAndNot(first, second);

        public override bool IsSupersetOf(string first, string second) => Base64Codec.BitwiseAndEquals(first, second);
    }
}